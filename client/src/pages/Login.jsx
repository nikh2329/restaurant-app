...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            login(data);
            toast.success('Welcome back to Swadha');
            navigate('/');
        } catch (err) {
        ...
        <div className="min-h-screen flex flex-col items-center justify-center px-margin-mobile">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-12">
                    <span className="font-label text-label-md text-primary tracking-[0.2em] uppercase">Welcome Back</span>
                    <h1 className="font-display text-display-lg-mobile text-on-surface mt-4">Sign In</h1>
                    <p className="font-body text-body-md text-on-surface-variant mt-4">
                        Continue your culinary journey with Swadha.
                    </p>
                </div>
                ...
                <div className="text-center mt-8">
                    <p className="font-body text-body-md text-on-surface-variant">
                        New to Swadha?{' '}
                        <Link to="/register" className="text-primary hover:opacity-80 transition-opacity font-label uppercase tracking-wider text-label-sm border-b border-primary/30 pb-0.5">
                            Create Account
                        </Link>
                    </p>
                </div>
